...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <p className="p3">For the purposes of this Privacy Policy:</p>
      <ul className="ul1">
        <li className="li3">
        ...
        <li className="li3">
          ...
          this Agreement) refers to HodanHogan Company, KF 2706 Adweso Two
          Streams.
        </li>
        <li className="li3">
      ...
      <ul className="ul1">
        <li className="li3">Email address</li>
        <li className="li3">First name and last name</li>
        <li className="li3">Phone number</li>
        <li className="li3">Usage Data</li>
      </ul>
      <p className="p4">
      ...
      <ul className="ul1">
        <li className="li3">Information regarding your location</li>
        <li className="li3">
      ...
      <ul className="ul1">
        <li className="li5">Comply with a legal obligation</li>
        <li className="li5">
        ...
        <li className="li5">Protect against legal liability</li>
      </ul>
      <p className="p4">
